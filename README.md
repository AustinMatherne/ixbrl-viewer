...
development dependencies (`pip install ".[arelle,dev]"`), then run the
...
The Ruff migration commits are listed in `.git-blame-ignore-revs` so that blame
can show the earlier changes to those lines. Enable this for your local clone:
